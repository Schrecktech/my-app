...
- Sync package-lock.json in release script
- Missing android package
- Sync the package and package-lock
- Remove unreferenced react logos
...
- Prevent hero text clipping in landscape and wide viewports
